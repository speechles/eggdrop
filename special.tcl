...
namespace eval incith {
  namespace eval google {
    ...
    variable my_customs {
      ...
      "yt youtube y:g:%search% site:youtube.com"
...
### END ONEBOX ###
        ...
        # regular search
          ...
          #}
	    if {![regexp -- {class="g"><div.*?<a href="(.*?)".*?>(.*?)</a>} $html - link desc]} {
            if {[regexp -- {class=g><div.*?<a href="(.*?)".*?>(.*?)</a>} $html - link desc]} {
              regsub -- {class=g><div.*?<a href=".*?".*?>.*?</a>} $html "" html
      ...
      if {[string length $results]} {
		...
		set new [list]
		  ...
		  if {[string length $::incith_hdr]} {
		      ...
		      lappend new [string map {"_" " "} [encoding convertto utf-8 [subtagDecode $anchor]]]
                } else {
	...
	# which will only work properly patched....
      if {[string match *&* $text]} {
        ...
        if {$::incith::google::dirty_decode > 0} {
          if {![string equal $incithcharset [encoding system]] && $::incith::google::use_gzip < 1} { set text [encoding convertfrom $incithcharset $text] }
          ...
          set text [subst "$text"]
          if {![string equal $incithcharset [encoding system]] && $::incith::google::use_gzip < 1} { set text [encoding convertto $incithcharset $text] }
        }
      }
